...
import com.hungrystudio.adx.operator.S3ForGeoedgeScanFlatMap;
...
public class KafkaToS3ForForGeoedgeScanByFlink {
    public static void main(String[] args) throws Exception {
        ...
        String chkParentPath = CommonUtil.getFlinkChkParentPath("prod", "KafkaToS3ForGeoedgeScanByFlink", "s3");  // 获取flink checkpoint父路径
        ...
        env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "KafkaSource")
                ...
                .uid("AdxScanSource")
                .name("AdxScanSource")
                .flatMap(new S3ForGeoedgeScanFlatMap(paramsJson))
        ...
        env.execute("Kafka to Parquet AdxScan");
    }
}
