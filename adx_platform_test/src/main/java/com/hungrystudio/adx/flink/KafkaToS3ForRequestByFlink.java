...
public class KafkaToS3ForRequestByFlink {
    public static void main(String[] args) throws Exception {
        ...
        String chkParentPath = CommonUtil.getFlinkChkParentPath("prod", "KafkaToS3ForRequestByFlink", "s3");  // 获取flink checkpoint父路径

        env.enableCheckpointing(60000 * 5); // Checkpoint 每 60 秒
        CheckpointConfig config = env.getCheckpointConfig();
        config.setCheckpointingMode(CheckpointingMode.EXACTLY_ONCE);
        config.setCheckpointTimeout(60000 * 5);
        config.setMinPauseBetweenCheckpoints(60000 * 5);
        ...
        // Kafka 消费者
//        KafkaSource<String> kafkaSource = KafkaUtil.getkafkaSource("msk",server, groupId, topic,"AdxClick");
        ...
        env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "KafkaSource")
                ...
                .uid("AdxRequestSource")
                .name("AdxRequestSource")
        ...
        env.execute("Kafka to Parquet AdxRequest");
    }
}
