 ...
 * @date 2021/5/25
 */
public class S3ForClickFlatMap extends RichFlatMapFunction <String, AdxClickData> implements CheckpointedFunction {


    private static final Logger LOG = LoggerFactory.getLogger(S3ForClickFlatMap.class);
    ...
    public S3ForClickFlatMap(JSONObject json, boolean flag) {
        this.json = json;
    ...
    public S3ForClickFlatMap(JSONObject json) {
        this.json = json;
    }
    ...
    @Override
    public void flatMap(String valueByte, Collector <AdxClickData> out) {
        ...
        AdxClickData adData = JsonUtils.fromJson(analysis.toJSONString(), AdxClickData.class);
        out.collect(adData);
    }
