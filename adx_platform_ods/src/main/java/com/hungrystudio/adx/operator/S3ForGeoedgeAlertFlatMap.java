 ...
 * @date 2021/5/25
 */
public class S3ForGeoedgeAlertFlatMap extends RichFlatMapFunction <String, AdxGeoedgeAlertData> implements CheckpointedFunction {


    private static final Logger LOG = LoggerFactory.getLogger(S3ForGeoedgeAlertFlatMap.class);
    ...
    public S3ForGeoedgeAlertFlatMap(JSONObject json) {
        this.json = json;
    }
    ...
    @Override
    public void flatMap(String valueByte, Collector <AdxGeoedgeAlertData> out) {
        ...
        AdxGeoedgeAlertData adData = JsonUtils.fromJson(analysis.toJSONString(), AdxGeoedgeAlertData.class);
        out.collect(adData);
    }
