 ...
 * @date 2021/5/25
 */
public class S3ForGeoedgeScanFlatMap extends RichFlatMapFunction <String, AdxGeoedgeScanData> implements CheckpointedFunction {


    private static final Logger LOG = LoggerFactory.getLogger(S3ForGeoedgeScanFlatMap.class);
    ...
    public S3ForGeoedgeScanFlatMap(JSONObject json) {
        this.json = json;
    }
    ...
    @Override
    public void flatMap(String valueByte, Collector <AdxGeoedgeScanData> out) {
        ...
        AdxGeoedgeScanData adData = JsonUtils.fromJson(analysis.toJSONString(), AdxGeoedgeScanData.class);
        out.collect(adData);
    }
