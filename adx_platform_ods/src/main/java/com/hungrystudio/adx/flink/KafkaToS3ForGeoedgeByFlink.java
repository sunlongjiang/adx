...
public class KafkaToS3ForGeoedgeByFlink {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("执行参数:sinkNum:"+timestamp);
        ...
        String chkParentPath = CommonUtil.getFlinkChkParentPath("prod", "KafkaToS3ForGeoedgeByFlink", "s3");  // 获取flink checkpoint父路径
        ...
        env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "KafkaSource")
                ...
                .uid("AdxGeoedgeSource")
                .name("AdxGeoedgeSource")
                .flatMap(new S3ForGeoedgeFlatMap(paramsJson))
        ...
        env.execute("Kafka to Parquet AdxGeoedge");
    }
}
