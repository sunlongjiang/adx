...
public class KafkaToS3ForClickByFlink {
...
//        String topic = "topic_adx_click";
        String logType = "AdxClick";
...
//        paramsJson.put("wait_min", "10");
        ...
        String chkParentPath = CommonUtil.getFlinkChkParentPath("prod", "KafkaToS3ForClickByFlink", "s3");  // 获取flink checkpoint父路径
        ...
        env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "KafkaSource")
                ...
                .uid("AdxClickSource")
                .name("AdxClickSource")
                .flatMap(new S3ForClickFlatMap(paramsJson))
        ...
        env.execute("Kafka to Parquet AdxClick");
    }
}
