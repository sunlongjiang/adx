...
import com.hungrystudio.adx.operator.S3ForShowFlatMap;
...
public class KafkaToS3ForShowByFlink {
    public static void main(String[] args) throws Exception {
        ...
        String chkParentPath = CommonUtil.getFlinkChkParentPath("prod", "KafkaToS3ForShowByFlink", "s3");  // 获取flink checkpoint父路径
        ...
        env.fromSource(kafkaSource, WatermarkStrategy.noWatermarks(), "KafkaSource")
                ...
                .uid("AdxShowSource")
                .name("AdxShowSource")
                .flatMap(new S3ForShowFlatMap(paramsJson))
        ...
        env.execute("Kafka to Parquet AdxShow");
    }
}
